...
Public Class ContactInvestigation1
    ...
    Protected Sub ASPxCallback1_Callback(ByVal sender As Object, ByVal e As CallbackEventArgsBase)
        ...
        _ContactLog.FirstContactInvestigationFailed = Session("_FirstContactInvestigationFailed")
            ...
            If hdWhichButton.Value = "Next" Then
                ...
                If Not IsNothing(tmpDebtor) Then
                    If tmpDebtor.AccountNumber = "" Then
                        'No accounts left
                        lblStatus.Text = "There are no accounts left!"
    ...
    Private Sub GetDebtor(ByVal AccountNumber As String)
        ...
        Session.Remove("_FirstContactInvestigationFailed")
        ...
        If Not IsNothing(_NewDebtor) Then
            ...
            Session("_FirstContactInvestigationFailed") = _NewDebtor.FirstContactInvestigationFailed
