<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="ContactInvestigation.aspx.vb" Inherits="pcm.Website.ContactInvestigation1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/Collections/contactinvestigation.js?id=1"></script>
        ...
        <tr>
            <td>
                ...
                <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" >
                    <Groups>
                        <dx:NavBarGroup Name="StartCalling" Text="Start Calling">
                            <Items>
                                <dx:NavBarItem Name="GetAccount" Text="Get an Account">
                                </dx:NavBarItem>
            ...
            <dx:PanelContent ID="PanelContent3" runat="server">
                ...
                <table class="main_table">
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td class="style3">
                            <dx:ASPxDateEdit ID="txtPTPDate" runat="server" ClientInstanceName="pd" DisplayFormatString="yyyy-MM-dd" EditFormat="Custom" EditFormatString="yyyy-MM-dd" UseMaskBehavior="True">
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxTextBox ID="txtPTPAmount" runat="server" ClientInstanceName="tp" Mask="0.00" MaskType="Numeric" Width="170px">
                ...
                <table class="notes_table">
                    <tr>
                        ...
                        <td class="auto-style5">
                            <dx:ASPxMemo ID="txtNotes" runat="server" Height="71px" Width="545px" ClientInstanceName="notes"
                                ValidationSettings-Display="Dynamic" ValidationSettings-ValidateOnLeave="true"
