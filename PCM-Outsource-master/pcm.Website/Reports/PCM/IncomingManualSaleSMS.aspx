<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="IncomingManualSaleSMS.aspx.vb" Inherits="pcm.Website.IncomigManualSaleSMS" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainHolder" runat="server">
    ...
    HeaderText="Incoming Manual Sale SMS" CssClass="date_panel">
            <PanelCollection>
   ...
   <dx:ASPxGridView ID="dxGrid" runat="server" CssClass="date_panel" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="From Number" FieldName="received_from" 
                VisibleIndex="1">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Sent To" FieldName="sent_to" VisibleIndex="2">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Message" FieldName="original_message" 
                VisibleIndex="3">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Waiting For Confirm." FieldName="waiting_for_confirmation" 
                VisibleIndex="4">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Auth Code" FieldName="confirmation_code" 
                VisibleIndex="5">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Reply SMS" FieldName="reply_sms" 
                VisibleIndex="6">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Amount" FieldName="sale_amount" 
                VisibleIndex="7">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Card Num." FieldName="card_number" 
                VisibleIndex="8">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Branch Code" FieldName="branch_code" 
                VisibleIndex="9">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Result" FieldName="sms_result" 
                VisibleIndex="10">
            </dx:GridViewDataTextColumn>
