...
Public Class IncomingRageSMS
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not url.Contains("localhost") Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("reporting_permission_sequence"), Screens.Reporting.IncomingRageSMS) Then
                    If Not IsCallback Then
    ...
    Protected Sub cmdRun_Click(sender As Object, e As EventArgs) Handles cmdRun.Click
        ...
        _Log.WebPage = "Incoming Rage Report"
    ...
    Protected Sub dxGrid_DataBinding(ByVal sender As Object, ByVal e As EventArgs)
        ...
        dxGrid.DataSource = _NewReport.GetRageSMSDetails(txtFromDate.Text, txtToDate.Text)
