        ...
        <PanelCollection>
            <dx:PanelContent ID="PanelContent3" runat="server">
                ...
                <div class="mainContainer">
                    ...
                    <br />
                       <table>
                        <tr>
                            ...
                            <td>
                                <dx:ASPxLabel ID="lblTotalSum" runat="server" Text="0" Width="120px">
                                </dx:ASPxLabel>
                            </td>
                            <td>
                    ...
                    <dx:WebChartControl ID="averageSaleChart" runat="server" Height="510px" CrosshairEnabled="True" OnDataBinding="transactionChart_DataBinding" PaletteName="Flow" Width="414px">
                        <DiagramSerializable>
                            <cc1:XYDiagram>
