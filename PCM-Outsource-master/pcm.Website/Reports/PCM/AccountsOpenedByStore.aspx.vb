...
Public Class AccountsOpenedByStore
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not HttpContext.Current.IsDebuggingEnabled Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("reporting_permission_sequence"), Screens.Reporting.AccountsByStore) Then
                    If Not IsCallback Then
        ...
        If Session("username").ToString.ToUpper <> "DANIEL" Then
            gvMaster.SettingsDetail.ExportMode = GridViewDetailExportMode.None
        Else
            gvMaster.SettingsDetail.ExportMode = GridViewDetailExportMode.Expanded
        End If
    ...
    Private Function GetData() As DataSet
        ...
        masterData = ReportData.GetAccountsOpenedByStore(txtFromDate.Text, txtToDate.Text)
        ...
        detailData = ReportData.GetAccountsOpenedByStoreTransactions(txtFromDate.Text, txtToDate.Text)
    ...
    Protected Sub cmdRun_Click(sender As Object, e As EventArgs) Handles cmdRun.Click
        ...
        _Log.WebPage = "Accounts Opened By Store"
