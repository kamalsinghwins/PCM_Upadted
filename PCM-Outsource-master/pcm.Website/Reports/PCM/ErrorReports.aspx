<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="ErrorReports.aspx.vb" Inherits="pcm.Website.ErrorReports" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainHolder" runat="server">
    ...
    <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" Width="200px"
        HeaderText="Error Report" CssClass="date_panel">
        <PanelCollection>
    ...
    <dx:ASPxGridView ID="gvError" OnDataBinding="gvError_DataBinding" runat="server" AutoGenerateColumns="False"  CssClass="date_panel" Width="98%"
        EnableTheming="True">

        <Columns>
            <dx:GridViewDataTextColumn Caption="Inner Exception" FieldName="inner_exception"
                VisibleIndex="0">
            ...
            <dx:GridViewDataTextColumn Caption="Stack Trace" FieldName="stack_trace" VisibleIndex="3">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Target Site" FieldName="target_site"
                VisibleIndex="4">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Data" FieldName="data"
                VisibleIndex="6">
            </dx:GridViewDataTextColumn>
             <dx:GridViewDataTextColumn Caption="Help Link" FieldName="help_link"
                VisibleIndex="7">
            </dx:GridViewDataTextColumn>
             <dx:GridViewDataTextColumn Caption="HResult" FieldName="hresult"
                VisibleIndex="8">
            </dx:GridViewDataTextColumn>
