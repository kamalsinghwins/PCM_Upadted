...
Public Class BadDebtByStore
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not HttpContext.Current.IsDebuggingEnabled Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("reporting_permission_sequence"), Screens.Reporting.BadDebtByStore) Then
                    If Not IsCallback Then
        ...
        If Not IsPostBack Then
            ...
            cboPeriod.Items.Add("30")
            cboPeriod.Items.Add("60")
            cboPeriod.Items.Add("90")
            cboPeriod.Items.Add("120")
            cboPeriod.Items.Add("150")
    ...
    Private Function GetData() As DataSet
        ...
        Dim ReportData As New ReportsBusinessLayer(Session("current_company"))

        Dim masterData As New DataTable

        masterData = ReportData.BadDebtByStoreMaster(txtFromDate.Text, txtToDate.Text, cboPeriod.Text, Val(txtOutstanding.Text))
        ...
        detailData = ReportData.BadDebtByStoreTransactions(txtFromDate.Text, txtToDate.Text)
    ...
    Protected Sub cmdRun_Click(sender As Object, e As EventArgs) Handles cmdRun.Click
        ...
        _Log.SearchCriteria = "From Date: " & txtFromDate.Text & " To Date: " & txtToDate.Text & " Outstanding " & txtOutstanding.Text & " Period " & cboPeriod.Text
        _Log.UserComment = ""
        _Log.UserName = Session("username")
        _Log.WebPage = "Bad Debt By Store Report"
    ...
    Private Sub BadDebtByStore_PreInit(sender As Object, e As System.EventArgs) Handles Me.PreInit
