...
Public Class HistoricalClockingReport
    Inherits System.Web.UI.Page
    Dim getHistoricalReport As New ReportsBusinessLayer
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not url.Contains("localhost") Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("reporting_permission_sequence"), Screens.Reporting.HistoricalClockingReport) Then
                    If Not IsCallback Then
    ...
    Private Sub HistoricalClockingReport_PreInit(sender As Object, e As System.EventArgs) Handles Me.PreInit
        DevExpress.Web.ASPxWebControl.GlobalTheme = "Office2010Blue"
    End Sub

    Protected Sub ASPxCallback1_Callback(ByVal sender As Object, ByVal e As CallbackEventArgsBase)
        If hdWhichButton.Value = "Run" Then
            Session.Remove("HistoricalReports")
            Try
                gvMaster.DataBind()
    ...
    Private Function GetMasterData() As DataTable
        ...
        If data IsNot Nothing Then
            Return data.Tables("MaterHistoricalData")
        Else
            Return Nothing
        End If
    End Function
    ...
    Private Function GetData() As DataSet
        If Not IsNothing(Session("HistoricalReports")) Then
            Return Session("HistoricalReports")
        End If
        ...
        masterData = getHistoricalReport.GetHistoricalClockingReport(Permanent, Casual, All, StartDate, EndDate)

        masterData.Tables(0).TableName = "MaterHistoricalData"
        masterData.Tables(1).TableName = "HistoricalDetails"
        masterData.Relations.Add("MasterDetail", masterData.Tables(0).Columns("branch_code"), masterData.Tables(1).Columns("branch_code"))

        Session("HistoricalReports") = masterData
    ...
    Private Function GetDetailData(ByVal masterRowKey As Object) As DataView
        ...
        If data IsNot Nothing Then
            Dim detail As DataTable = data.Tables("HistoricalDetails")
