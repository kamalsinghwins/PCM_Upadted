<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="CashTransactionsReport.aspx.vb" Inherits="pcm.Website.CashTransactionsReport" %>
            ...
            <dx:PanelContent ID="PanelContent3" runat="server">
                ...
                <div class="mainContainer">
                    <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" Width="200px"
                        HeaderText="Cash Transactions Report" CssClass="mb-20">
                        <PanelCollection>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="7" class="auto-style2">
                                            ...
                                            <dx:ASPxCheckBox ID="chkSales" runat="server" Text="Sales" CheckState="Checked">
                                            </dx:ASPxCheckBox>
                                            <dx:ASPxCheckBox ID="chkPin" runat="server" Text="Paid In" CheckState="Checked">
                                            </dx:ASPxCheckBox>
                                            <dx:ASPxCheckBox ID="chkCn" runat="server" Text="Credit Notes" CheckState="Checked">
                                            </dx:ASPxCheckBox>
                                            <dx:ASPxCheckBox ID="chkPout" runat="server" Text="Paid Out" CheckState="Checked">
                                            </dx:ASPxCheckBox>
                                            <dx:ASPxCheckBox ID="chkRefunds" runat="server" Text="Refunds" CheckState="Checked">
                                            </dx:ASPxCheckBox>
                                            <dx:ASPxCheckBox ID="chkAccpay" runat="server" Text="Account Payments" CheckState="Checked">
                                            </dx:ASPxCheckBox>
                                        </td>
                                    </tr>
