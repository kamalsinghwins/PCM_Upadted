...
Public Class TasksReport
    ...
    Private Function GetReports() As DataSet
        ...
        If Not IsNothing(Session("taskreports")) Then
            Return Session("taskreports")
        End If
        ...
        reports = GetTasksReports.GetReports(txtFromDate.Text, txtToDate.Text)

        Dim data As DataSet
        reports.TableName = "Tasks"

        data = New DataSet()
        data.Tables.Add(reports)
        Session("taskreports") = data
    ...
    Protected Sub gvReport_DataBinding(ByVal sender As Object, ByVal e As EventArgs)
        ...
        gridView.KeyFieldName = "tasks_id"
        gridView.DataSource = data
        gvReports.EndUpdate()

    End Sub

    Private Sub TaskReports_PreInit(sender As Object, e As System.EventArgs) Handles Me.PreInit
