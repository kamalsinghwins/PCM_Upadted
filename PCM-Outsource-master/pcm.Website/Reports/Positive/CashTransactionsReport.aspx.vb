    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not HttpContext.Current.IsDebuggingEnabled Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("reporting_permission_sequence"), Screens.Reporting.CashTransactionsReport) Then
                    If Not IsCallback Then
        ...
        End If
    End Sub
    Private Sub CashTransactionsReport_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
    ...
    Protected Sub ASPxCallback1_Callback(ByVal sender As Object, ByVal e As CallbackEventArgsBase)
        ...
        Try
            If hdWhichButton.Value = "Run" Then
                RunCashTransactionsReport()
            End If
        Catch ex As Exception
            _blErrorLogging.ErrorLogging(ex)
        End Try
    End Sub
    Public Sub RunCashTransactionsReport()
        ...
        Dim cashTransactions As New Entities.Reports.CashTransactionsReport
        cashTransactions.Sales = chkSales.Checked
        cashTransactions.PaidIn = chkPin.Checked
        cashTransactions.CreditNotes = chkCn.Checked
        cashTransactions.PaidOut = chkPout.Checked
        cashTransactions.Refunds = chkRefunds.Checked
        cashTransactions.AccountPayments = chkAccpay.Checked
        cashTransactions.Branches = listBranches
        cashTransactions.IsAdmin = Session("is_pcm_admin")
        cashTransactions.IPAddress = Session("ipaddress")
        Dim json As String = JsonConvert.SerializeObject(cashTransactions)


        ReturnString = _BLayer.RunCashTransactionsReport(txtFromDate.Text, txtToDate.Text, email, username, json)
