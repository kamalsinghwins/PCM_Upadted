<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="VoidsAndNoSales.aspx.vb" Inherits="pcm.Website.VoidsAndNoSales" %>
            ...
            <dx:PanelContent ID="PanelContent3" runat="server">
                ...
                <div class="mainContainer">
                    <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" Width="200px"
                        HeaderText="Voids And No Sales Report" CssClass="mb-20">
                        <PanelCollection>
                    ...
                    <dx:ASPxGridView ID="gvReports" runat="server" AutoGenerateColumns="False" Width="100%" OnDataBinding="gvReports_DataBinding"
                        EnableTheming="True">
                        <Columns>
                            <dx:GridViewDataTextColumn Caption="Void Date" FieldName="void_date" VisibleIndex="0">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Void Time" CellStyle-CssClass="ellipsis" FieldName="void_time" VisibleIndex="1">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Username" FieldName="user_name" VisibleIndex="2">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Generated Code" FieldName="generated_code" VisibleIndex="3">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Quantity" FieldName="quantity" VisibleIndex="4">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Branch Name" FieldName="branch_name" VisibleIndex="5">
                            </dx:GridViewDataTextColumn>
                        </Columns>
