...
Public Class NewCashUp
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not HttpContext.Current.IsDebuggingEnabled Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("reporting_permission_sequence"), Screens.Reporting.NewCashUp) Then
                    If Not IsCallback Then
    ...
    Public Sub RunCashSummaryReport()
        ...
        Dim cashSummary As New Entities.Reports.CashSummary
        cashSummary.IPAddress = Session("ipaddress")
        cashSummary.IsAdmin = Session("is_pcm_admin")
        cashSummary.Branches = listBranches

        Dim json As String = JsonConvert.SerializeObject(cashSummary)

        ReturnString = _BLayer.RunCashSummaryReport(txtFromDate.Text, txtToDate.Text, json, email, username)
