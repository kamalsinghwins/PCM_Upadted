...
Public Class VoidsAndNoSales
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not url.Contains("localhost") Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("reporting_permission_sequence"), Screens.Reporting.VoidsAndNoSales) Then
                    If Not IsCallback Then
        ...
        End If
    End Sub
    Private Sub VoidsAndNoSales_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
    ...
    Private Sub Run()
        If chkAll.Checked = False Then
            ...
            End If
        End If
        Session.Remove("VoidsAndNoSales")
        gvReports.DataBind()
    End Sub
    ...
    Private Function GetMasterData() As DataTable
        ...
        If data IsNot Nothing Then
            Return data.Tables("VoidsAndNoSales")
        Else
            Return Nothing
        End If
    End Function
    Private Function GetReports() As DataSet
        ...
        If Not IsNothing(Session("VoidsAndNoSales")) Then
            Return Session("VoidsAndNoSales")
        End If
        ...
        reports = _reports.GetVoidsAndNoSalesReports(txtFromDate.Text, txtToDate.Text, branches)

        Dim data As DataSet
        reports.TableName = "VoidsAndNoSales"

        data = New DataSet()
        data.Tables.Add(reports)
        Session("VoidsAndNoSales") = data
