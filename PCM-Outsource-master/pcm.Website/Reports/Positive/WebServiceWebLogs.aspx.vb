...
Public Class WebServiceWebLogs
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not url.Contains("localhost") Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("reporting_permission_sequence"), Screens.Reporting.WebServiceWebLogs) Then
                    If Not IsCallback Then
    ...
    Private Function GetReports() As DataSet
        ...
        If Not IsNothing(Session("webserviceweblogs")) Then
            Return Session("webserviceweblogs")
        End If
        ...
        reports = GetTasksReports.GetWebServiceWebLogs(txtFromDate.Text, txtToDate.Text)

        Dim data As DataSet
        reports.TableName = "webserviceweblogs"

        data = New DataSet()
        data.Tables.Add(reports)
        Session("webserviceweblogs") = data
    ...
    End Sub
    Private Sub WebServiceWebLogs_PreInit(sender As Object, e As System.EventArgs) Handles Me.PreInit
