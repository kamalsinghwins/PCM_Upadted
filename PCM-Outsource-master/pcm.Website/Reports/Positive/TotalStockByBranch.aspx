<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="TotalStockByBranch.aspx.vb" Inherits="pcm.Website.TotalStockByBranch" %>
            ...
            <dx:PanelContent ID="PanelContent3" runat="server">
                ...
                <div class="mainContainer">
                    <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" Width="200px"
                        HeaderText="Total Stock By Branch" CssClass="date_panel">
                        <PanelCollection>
                            <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                <table>
                                    <tr>
                                        <td>
                                            <dx:ASPxLabel ID="lblBranch" runat="server" Text="Branch" Width="120px">
                                            </dx:ASPxLabel>
                                        </td>
                                        <td>
                                            <dx:ASPxComboBox ID="cboBranchType" ClientInstanceName="cboBranchType" Width="250px"
                                                runat="server" AutoPostBack="false" ValueType="System.String">
                                            </dx:ASPxComboBox>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <dx:ASPxLabel ID="lblGeneratedCode" runat="server" Text="Generated Code" Width="90px">
                                            </dx:ASPxLabel>
                                        </td>
                                        <td>
                                            <dx:ASPxTextBox ID="txtGeneratedCode" ClientInstanceName="GeneratedCode" CssClass="UpperCase" runat="server" Width="250px">
                                            </dx:ASPxTextBox>
                                        </td>
                                        <td></td>
                                    </tr>
                    ...
                    <dx:ASPxGridView ID="gvReports" runat="server" OnDataBinding="gvReport_Databinding" AutoGenerateColumns="False" CssClass="date_panel" Width="98%"
                        EnableTheming="True">
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn  Settings-ShowFilterRowMenu="True" Caption="Quantity On Hand" FieldName="qty_on_hand"
                                VisibleIndex="2">
                            </dx:GridViewDataTextColumn>                           
                        </Columns>
                        ...
                        <TotalSummary>
                            <dx:ASPxSummaryItem FieldName="qty_on_hand" SummaryType="Sum" />
                        </TotalSummary>
                    </dx:ASPxGridView>
                    <table>
                        <tr>
