<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="TasksReport.aspx.vb" Inherits="pcm.Website.TasksReport" %>
...
<dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" Width="200px"
    ...
    <dx:ASPxGridView ID="gvReports" OnDataBinding="gvReport_DataBinding" runat="server" AutoGenerateColumns="False"  CssClass="date_panel" Width="98%"
        ...
        <Columns>
            <dx:GridViewDataTextColumn Caption="Report Type" FieldName="task_type"
                VisibleIndex="0">
            </dx:GridViewDataTextColumn>     
            <dx:GridViewDataTextColumn Caption="Created On" FieldName="timestamp_created"
                VisibleIndex="1">
            </dx:GridViewDataTextColumn>     
             <dx:GridViewDataTextColumn Caption="Start Date" FieldName="start_date"
                VisibleIndex="2">
            </dx:GridViewDataTextColumn>
             <dx:GridViewDataTextColumn Caption="End Date" FieldName="end_date"
                VisibleIndex="3">
            </dx:GridViewDataTextColumn>
             <dx:GridViewDataTextColumn Caption="Email" FieldName="email_addresses"
                VisibleIndex="4">
            </dx:GridViewDataTextColumn>
             <dx:GridViewDataTextColumn Caption="Completed" FieldName="task_completed" VisibleIndex="5">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Created By" FieldName="username"
                VisibleIndex="6">
            </dx:GridViewDataTextColumn>          
            <dx:GridViewDataTextColumn Caption="Error" FieldName="error_occured"
                VisibleIndex="7">
            </dx:GridViewDataTextColumn>          
                  </Columns>
