<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="GRV.aspx.vb" Inherits="pcm.Website.GRV" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" src="../../js/Positive/HeadOffice/GRV.js"></script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainHolder" runat="server">
        ...
        <div style="width: 87%; float: left;">
            <table class="dxrpControl_Office2010Blue" cellspacing="0" cellpadding="0" style="width: 100%; border-collapse: collapse; border-collapse: separate;">
                <tbody>
                    <tr>
                        <td class="dxrpHeader_Office2010Blue dx-borderBox"><span class="dxrpHT dx-vam">GRV</span></td>
                    </tr>
                    <tr class="dxrpCR">
                                ...
                                <div class="dx-borderBox dxrpCW">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <span class="dxeBase_Office2010Blue"> Supplier Account</span>
                                                </td>
                                                <td>&nbsp;
                                                </td>
                                                <td>&nbsp;
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="dxic" style="width: 100%;">
                                                                    <input id="txtSupplierAccount" style="text-transform: uppercase" class="dxeEditArea_Office2010Blue dxeEditAreaSys" onkeypress="setSupplier()" type="text" /></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                                <td></td>
                                                <td>
                                                    <img id="Search" onclick="searchSupplier()" style="margin-left: 6px;" class="dxeImage_Office2010Blue" src="../../images/search.png" alt="" />
                                                </td>
                                                <td>&nbsp;
                                                </td>
                                                <td></td>
                                                <td>
                                                    <span class="dxeBase_Office2010Blue">Supplier Name</span>
                                                </td>
                                                <td>&nbsp;
                                                </td>
                                                <td></td>
                        ...
                        <td>
                            ...
                            <table class="dxeTextBoxSys dxeTextBox_Office2010Blue dxeTextBoxDefaultWidthSys " cellspacing="0" cellpadding="0" style="width: 100px; border-collapse: collapse;">
                                <tbody>
                                    <tr>
                                        <td class="dxic" style="width: 100%;">
                                            <input class="dxeEditArea_Office2010Blue dxeEditAreaSys text-truncate" onkeypress="getItemCodes()" style="text-transform: uppercase" name="txtItemCode" id="txtItemCode"  type="text" /></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                        <td>
                            ...
                            <table class="dxeTextBoxSys dxeTextBox_Office2010Blue dxeTextBoxDefaultWidthSys " cellspacing="0" cellpadding="0"  style="width: 150px; border-collapse: collapse;">
                                <tbody>
                                    <tr>
                                        <td class="dxic" style="width: 100%;">
                                            <input class="dxeEditArea_Office2010Blue dxeEditAreaSys text-truncate" disabled="disabled"  id="txtDescription" name="txtDescription" type="text" /></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                        <td>
                            ...
                            <table class="dxeTextBoxSys dxeTextBox_Office2010Blue dxeTextBoxDefaultWidthSys " cellspacing="0" cellpadding="0" style="width: 80px; border-collapse: collapse;">
                                <tbody>
                                    <tr>
                                        <td class="dxic" style="width: 100%;">
                                            <input class="dxeEditArea_Office2010Blue dxeEditAreaSys text-truncate" disabled="disabled"  id="txtExcl" type="text" /></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                        ...
                        <td>
                            ...
                            <table class="dxeTextBoxSys dxeTextBox_Office2010Blue dxeTextBoxDefaultWidthSys" cellspacing="0" cellpadding="0"  style="width: 100px; border-collapse: collapse;">
                                <tbody>
                                    <tr>
                                        <td class="dxic" style="width: 100%;">
                                            <input class="dxeEditArea_Office2010Blue dxeEditAreaSys text-truncate" disabled="disabled" name="txtIncl" id="txtIncl" type="text" /></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                        <td>
                            ...
                            <table class="dxeTextBoxSys dxeTextBox_Office2010Blue dxeTextBoxDefaultWidthSys" cellspacing="0" cellpadding="0" style="width: 50px; border-collapse: collapse;">
                                <tbody>
                                    <tr>
                                        <td class="dxic" style="width: 100%;">
                                            <input class="dxeEditArea_Office2010Blue dxeEditAreaSys text-truncate" name="txtQty" id="txtQty"  onkeypress="AddNewItem()" type="text" /></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                        <td>
                            ...
                            <table class="dxeTextBoxSys dxeTextBox_Office2010Blue dxeTextBoxDefaultWidthSys" cellspacing="0" cellpadding="0"  style="width: 80px; border-collapse: collapse;">
                                <tbody>
                                    <tr>
                                        <td class="dxic" style="width: 100%;">
                                            <input class="dxeEditArea_Office2010Blue dxeEditAreaSys text-truncate" disabled="disabled" name="txtTotalCostIncl" id="txtTotalIncl" type="text" /></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
            ...
            <div onclick="remove()" class="dxbButton_Office2010Blue dxbButtonSys dxbTSys pull-right" style="-webkit-user-select: none;margin-top: 10px;">
                <div class="dxb">
                    <div class="dxb-hbc" onclick="remove()">
                        <input type="button" onclick="remove()" class="btn  btn-primary" value="save" id="cmdUpdateQty" />
                    </div>
                        ...
                        <tbody>
                            <tr>
                              ...
                              <td></td>
                               ...
                               <tr>
                                <td>
<%--                                    <span class="dxeBase_Office2010Blue">Current Qty of Selected Item:</span>--%>
                                </td>
                                <td></td>
                                <td style="padding-left :20px">
<%--                                   <label id="lblCurrentQTY">0.00</label>--%>
                                </td>
                            </tr> 
                            <tr>
                                <td>
                                    <span class="dxeBase_Office2010Blue">Total Quantity</span>
                                </td>
                                <td></td>
                                <td style="padding-left :20px">
                                   <label id="lblQty">0.00</label>
                                </td>
                            </tr>  
                    ...
                    <table class="pull-right">
                        <tbody>
                            <tr>
                                ...
                                <td></td>
                                <td style="padding-left :20px">
                                    <label id="lblTotalExcl">0.00</label>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td style="padding-left :20px">
                                    <label id="lblTotalTax">0.00</label>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td style="padding-left :20px">
                                    <label id="lblTotalIncl">0.00</label>
                ...
                <div class="dxb">
                    ...
                    <span class="dx-vam">Save</span>
                     ...
                     <div style="width: 13%; float: right; padding: 0 30px">
            <br />
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <br />
                         <div class="row">
                            <div class="col-sm-12">
                                ...
                                <input id="txtSearch" onkeypress="doSearch()" style="text-transform: uppercase"  type="text" class="form-control" />
                            </div>
                            </div>
                          <div class="row">
                            <div class="col-sm-3">
                        ...
                        <div id="searchData" class="mt">
                            <table id="gridSupplier" class="table table-bordered table-hover" style="visibility: hidden">
                                <thead>
                                    <tr>
                                        <th>Supplier Code
                                        </th>
                            ...
                            <table id="gridItemCode" class="table table-bordered table-hover" style="visibility: hidden">
                            <thead>
                                <tr>
                                    <th>Item Code
                                    </th>
