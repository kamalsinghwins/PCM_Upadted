...
Public Class ScreensaverImages
    ...
    Protected Sub UploadControl_FilesUploadComplete(ByVal sender As Object, ByVal e As FilesUploadCompleteEventArgs)
        ...
        Dim _BLayer As New ScreensaverHOBL(Session("current_company"))
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not HttpContext.Current.IsDebuggingEnabled Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("maintenance_permission_sequence"), Screens.Maintenance.ManageScreensaverImages) Then
                    If Not IsCallback Then
    ...
    Protected Sub ASPxCallback1_Callback(ByVal sender As Object, ByVal e As CallbackEventArgsBase) Handles ASPxCallbackPanel1.Callback
        ...
        If hdWhichButton.Value = "Accept" Then
            ...
            For i As Integer = grdImages.VisibleStartIndex To grdImages.VisibleStartIndex + grdImages.SettingsPager.PageSize - 1
            ...
            Else
                lblError.Text = "The Screensaver Image listing has been updated!"
            End If
        End If
