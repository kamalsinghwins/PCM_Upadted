<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="StockAdjustments.aspx.vb" Inherits="pcm.Website.StockAdjustments" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" src="../../js/Positive/HeadOffice/StockAdjustments.js"></script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainHolder" runat="server">
        ...
        <div style="width: 87%; float: left;">
            <table class="dxrpControl_Office2010Blue" cellspacing="0" cellpadding="0" style="width: 100%; border-collapse: collapse; border-collapse: separate;">
                <tbody>
                    <tr>
                        <td class="dxrpHeader_Office2010Blue dx-borderBox"><span class="dxrpHT dx-vam">Stock Adjustments</span></td>
                    </tr>
                    <tr class="dxrpCR">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="dxic" style="width: 100%;">
                                                                    <input id="txtBranchCode" style="text-transform: uppercase" class="dxeEditArea_Office2010Blue dxeEditAreaSys" onkeypress="setBranch()" type="text" /></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                    ...
                    <div class="modal-body">
                        ...
                        <br />
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                                <label></label>
                                <input type="button" onclick="search()" class="btn  btn-primary pull-right " value="Search" id="Grid" />
                            </div>
                        </div>                      
                          <div class="row">
                            <div class="col-sm-3">
                        ...
                        <div id="searchData" class="mt">
                            <table id="gridBranch" class="table table-bordered table-hover" style="visibility: hidden">
                                <thead>
                                    <tr>
                                        <th>Branch Code
                                        </th>
