...
Imports Entities
Public Class StockQuantityImport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not HttpContext.Current.IsDebuggingEnabled Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("maintenance_permission_sequence"), Screens.Maintenance.ImportStockQuantity) Then
                    If Not IsCallback Then
        ...
        End If
    End Sub
    Private Sub StockQuantityImport_PreInit(sender As Object, e As System.EventArgs) Handles Me.PreInit
        ...
        For i As Integer = 0 To UploadControl.UploadedFiles.Length - 1
            ...
            If file.FileName <> "" AndAlso file.IsValid Then
                Try
                    ...
                    ReturnString = _manage.RunImport(fileName, txtEmail.Text, "StockQuantity", username)
    ...
    Private Sub Download()
        ASPxWebControl.RedirectOnCallback("~/temp/Import/" & "StockQuantityImportSample.txt")
    End Sub
End Class