<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="ManageStationary.aspx.vb" Inherits="pcm.Website.ManageStationary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function confirm(s, e) {
            ...
            var stationarycode = txtStationaryCode.GetText()
            var description = txtDescription.GetText()
            if (stationarycode == '') {
                lblConfirmation.SetText("You need to enter a Stationary Code")
        ...
        function clear(s, e) {
            e.processOnServer = false;
            txtStationaryCode.SetText('')
            txtDescription.SetText('')

        }

        function searchStationary(s, e) {
            e.processOnServer = false;

            document.getElementById('<%=hdWhichButton.ClientID%>').value = "SearchStationary";

            lp.Show();
            cab.PerformCallback();
        }

        function selectStationary(s, e) {
            e.processOnServer = false;

            document.getElementById('<%=hdWhichButton.ClientID%>').value = "SelectStationary";
            ...
            <dx:PanelContent ID="PanelContent3" runat="server">
                ...
                <div class="mainContainer">
                    <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" Width="300px"
                        HeaderText="Manage Stationary">
                        <PanelCollection>
                            <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                <table>
                                    <tr>
                                        <td>
                                            <dx:ASPxLabel ID="lblStationaryCode" runat="server" Width="150px" Text="Stationary Code">
                                            </dx:ASPxLabel>
                                        </td>
                                        <td style="display: -webkit-inline-box;">
                                            <dx:ASPxTextBox ID="txtStationaryCode" ClientInstanceName="txtStationaryCode" MaxLength="3" CssClass="UpperCase" runat="server" Width="210">
                                            </dx:ASPxTextBox>
                                            ...
                                            <asp:Panel ID="Panel1" runat="server">
                                                <table border="0" cellpadding="4" cellspacing="0" id="PopupContentDiv">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <dx:ASPxComboBox ID="cboStationaryType" ClientInstanceName="cboSearchType" Width="100%"
                                                        ...
                                                        <td>
                                                            <dx:ASPxButton ID="cmdSearch" runat="server" Text="Search" AutoPostBack="false">
                                                                <ClientSideEvents Click="searchStationary" />
                                                            </dx:ASPxButton>
                                                        </td>
                                                        <td></td>
                                                        <td>&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="11">
                                                            <dx:ASPxButton ID="cmdSelect" runat="server" Text="Select" AutoPostBack="false">
                                                                <ClientSideEvents Click="selectStationary" />
                                                            </dx:ASPxButton>
                                                        </td>
                                                    </tr>
                                                </table>
