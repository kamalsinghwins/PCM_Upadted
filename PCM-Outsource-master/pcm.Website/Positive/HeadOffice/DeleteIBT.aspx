<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="DeleteIBT.aspx.vb" Inherits="pcm.Website.DeleteIBT" %>
                        ...
                        <PanelCollection>
                            <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <dx:ASPxLabel ID="lblReason" runat="server" Width="120px" Text="Reason">
                                            </dx:ASPxLabel>
                                        </td>
                                        <td>
                                            <dx:ASPxComboBox ID="cboReason" ClientInstanceName="cboBranch" Width="100%"
                                                runat="server" AutoPostBack="false" ValueType="System.String">
                                            </dx:ASPxComboBox>
                                        </td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>
                                            <dx:ASPxLabel ID="lblAuthorisedBy" runat="server" Width="120px" Text="Authorised By">
                                            </dx:ASPxLabel>
                                        </td>
                                        <td>

                                            <dx:ASPxTextBox ID="txtAuthorisedBy" runat="server" Width="230px">
                                            </dx:ASPxTextBox>
                                        </td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="float: right">
                                                <dx:ASPxButton AutoPostBack="false" ID="btnDelete" runat="server" Text="Delete IBT">
                                                    <ClientSideEvents Click="deleteIbt" />
                                                </dx:ASPxButton>
                                            </div>
                                        </td>
