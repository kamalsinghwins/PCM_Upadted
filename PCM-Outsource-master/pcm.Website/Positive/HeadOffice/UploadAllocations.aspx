<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="UploadAllocations.aspx.vb" Inherits="pcm.Website.UploadAllocations" %>
    ...
    <script type="text/javascript">
        ...
        function FilesUploadComplete(s, e) {
            ...
            if (e.errorText != "")
                ...
                ShowMessage("File uploading has been successfully completed. The email with your IBT Outs will be sent shortly.");
        }
