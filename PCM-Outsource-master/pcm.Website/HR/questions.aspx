<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Intranet/Intranet.Master" CodeBehind="questions.aspx.vb" Inherits="pcm.Website.questions" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-12">
                                <div class="text-right mt-20">
                                    <a class="btn btn-primary" id="btnAddQuestion"  onclick="OpenAddQuestionPopup()">Add Question</a>
                                    <a class="btn btn-default" href="listing.aspx">Back</a>
                                </div>
                            </div>
                        </div>


                        <div id="QuestionList" style="overflow-wrap: break-word;">
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
                    ...
                    if (QuestionList && QuestionList.length > 0) {
                        for (var i = 0; i < QuestionList.length; i++) {
                            QuestionListHtml += '<div class="question_block padding light-grey" id="question_' + QuestionList[i].question_id + '">\
                                                <p class="large" > '+ (i+1) + ". " + QuestionList[i].question_text + '</p>';
                            ...
                            QuestionListHtml += '<div class="action_buttons_block">\
                                              <a class="btn btn-primary" data-question="' + QuestionList[i].question_id + '" onclick="EditQuestion(this)" ' + (data.d.IsExists ? 'disabled' : '') + ' >Edit Question</a>\
                                              <a class="btn btn-danger" data-question="' + QuestionList[i].question_id + '" onclick="DeleteQuestion(this)" ' + (data.d.IsExists ? 'disabled' : '') + '>Delete Question</a>\
                                             </div>\
                                            </div>';
                            if (data.d.IsExists ==true)
                            {
        ...
        function OpenAddQuestionPopup() {
            var popup_html = '<div  id="message"> </div>\
                        <div class="form-group">\
							<label for="txtAddQuestion">Question </label>\
							<input type="text"  id="txtQuestion" maxlength="250" class="form-control" placeholder="Question" />\
						</div>\
						<div class="form-group">\
							<label for="txtAddQuestion">Answer Options </label>\
						</div>\
						<div class="answer-options-container">\
							<table class="table answer-options">\
								<tr>\
									...
									<td>\
										<input type="text" name="options[]" maxlength="150" class="form-control" onblur="AddValueToAnwerRadio(this)" />\
									</td>\
									<td align="right"></td>\
								</tr>\
								<tr>\
        ...
        function SaveQuestionDetail(element) {
            ...
            if (ValidationCheck) {
                ...
                PostDataRequest["question_text"] = btoa($("#txtQuestion").val());
                ...
                OptionSelector.each(function () {
                    ...
                    AnswerOption["option_text"] = btoa(OptionValue);
