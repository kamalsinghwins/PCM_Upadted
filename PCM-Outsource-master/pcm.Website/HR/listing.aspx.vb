...
Public Class listing
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not HttpContext.Current.IsDebuggingEnabled Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("maintenance_permission_sequence"), Screens.Maintenance.Questionnaire) Then
                    If Not IsCallback Then
    ...
    Protected Sub ASPxCallback1_Callback(ByVal sender As Object, ByVal e As CallbackEventArgsBase)
        ...
        If hdWhichButton.Value = "CopySurvey" Then
            CopySurvey()
        End If
    ...
    Protected Sub OpenEditSurveyPopup()
        ...
        If selectedValues.Count > 0 Then
            ...
            SurveyPopup.HeaderText = "Update Questionnaire"
    ...
    Protected Sub CopySurvey()
        ...
        If selectedValues.Count > 0 Then
            Dim copySurveyResponse As New BaseResponse

            Dim survey_id As String = selectedValues(selectedValues.Count - 1)
            copySurveyResponse = _Survey.CopySurvey(survey_id)

            If (copySurveyResponse.Success = False) Then
                dxPopUpError.HeaderText = "Error"
                lblError.Text = copySurveyResponse.Message
                dxPopUpError.ShowOnPageLoad = True
                Exit Sub
            Else
                GetSurvey()
