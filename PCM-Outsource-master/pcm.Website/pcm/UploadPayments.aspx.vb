...
Public Class UploadPayments
    ...
    Protected Sub UploadControl_FilesUploadComplete(ByVal sender As Object, ByVal e As FilesUploadCompleteEventArgs)
        ...
        Dim _BLayer As New DebtorsBusinessLayer
        ...
        For i As Integer = 0 To UploadControl.UploadedFiles.Length - 1
            ...
            If file.FileName <> "" AndAlso file.IsValid Then
                Try
                    ...
                    ReturnString = _BLayer.RunPaymentUpload(fileName, txtEmail.Text, chkIDNumber.Checked)
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not HttpContext.Current.IsDebuggingEnabled Then
            If Session("username") = "" Then
                ...
                End If
            Else
                If Not CheckScreenAccess.CheckAccess(Session("processing_permission_sequence"), Screens.Processing.PCMUploadPayments) Then
                    If Not IsCallback Then
